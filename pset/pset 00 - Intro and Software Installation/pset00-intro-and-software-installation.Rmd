...
![](img/Screenshot 2024-01-18 at 3.46.10.png)
...
```
Note: there was no output/errors when I ran the above chunk as I had previously loaded all of the packages.
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Alan Phlips's animation")
g
...
![](img/Screenshot 2024-01-18 at 4.01.32.png)
...
![](img/Screenshot 2024-01-18 at 4.12.18.png)
...
![](img/Screenshot 2024-01-19 at 10.38.26.png)
